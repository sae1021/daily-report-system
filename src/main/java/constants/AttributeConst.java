...
public enum AttributeConst {
    ...
    //勤怠管理
    ATTENDANCE("attendance"), ATTENDANCES("attendances"), ATT_COUNT("attendances_count"), ATT_ID("id"), ATTENDANCE_DATE("attendance_date"),ATTEND_AT("attend_at"),LEAVE_AT("leave_at");
